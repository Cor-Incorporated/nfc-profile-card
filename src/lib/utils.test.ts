...
describe('Utility Functions', () => {
  describe('cn (className merger)', () => {
    ...
    it('should handle object notation', () => {
      ...
      expect(cn('base', { 'text-lg': true, 'font-bold': true })).toBe('base text-lg font-bold')
    })
    ...
    it('should merge complex Tailwind utilities', () => {
      ...
      ).toBe('px-4 py-2 text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500')
    })
  })
})
